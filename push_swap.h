...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/11/26 15:00:11 by kerama            #+#    #+#             */
/*   Updated: 2025/11/26 15:11:39 by kerama           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				rotate_ab_bench(t_dcll **stack_a, t_dcll **stack_b,
						t_ops *o);
void				rev_rotate_ab_bench(t_dcll **stack_a, t_dcll **stack_b,
						t_ops *o);
...
void				push_chunk_bench(t_dcll **stack_a, t_dcll **stack_b,
						int min, int max, t_ops *o);
void				new_chunk(int *min, int *max, int chunk);
void				chunk_based_sort_bench(t_dcll **stack_a, t_dcll **stack_b,
						int size, t_ops *o);
void				push_chunk(t_dcll **stack_a, t_dcll **stack_b, int min,
						int max);
void				new_chunk(int *min, int *max, int chunk);
void				chunk_based_sort(t_dcll **stack_a, t_dcll **stack_b,
						int size);
...
void				handle_format(const char *ptr, int *i, int *total,
						va_list args);
...
void				ht_set(ht_t *hashtable, unsigned int key,
						unsigned int value, size_t size);
...
void				min_max_extraction_bench(t_dcll **stack_a, t_dcll **stack_b,
						t_ops *o);
